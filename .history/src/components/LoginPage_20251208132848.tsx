function LoginPage() {
  return (
    ...
    >
      ...
      {/* فرم */}
      <div className="relative flex flex-col justify-center px-4 py-8 sm:px-6 sm:py-12 w-full max-w-md md:max-w-lg bg-white border border-gray-300 rounded-lg shadow-md">
        {/* عنوان */}
        <h2 className="text-center text-xl md:text-2xl font-bold tracking-tight text-black">
          ورود
        </h2>
