...
function LoginPage() {
  return (
    <div
      className="min-h-screen flex items-center justify-center relative bg-blue-400"
      dir="rtl"
    >
      {/* پس‌زمینه بلور */}
      <div className="absolute inset-0 bg-blue-100 bg-opacity-70 backdrop-blur-sm"></div>
