          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                className="block w-full rounded-md bg-blue-500 px-3 py-2 text-base text-white border border-gray-400 placeholder:text-gray-200 focus:border-indigo-500 focus:outline-none sm:text-sm"
              />
            </div>
          </div>
