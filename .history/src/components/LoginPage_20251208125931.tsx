...
function LoginPage() {
  return (
    <div
      className="min-h-screen flex items-center justify-center relative bg-blue-600"
      dir="rtl"
    >
      {/* پس‌زمینه بلور */}
      <div className="absolute inset-0 bg-blue-300 bg-opacity-70 backdrop-blur-sm"></div>

      {/* فرم چایلد با بوردر و پس‌زمینه سفید */}
