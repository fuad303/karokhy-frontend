...
function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col justify-center px-6  py-6 sm:py-12 my-5 sm:my-0  sm:w-full sm:max-w-sm bg-white border border-gray-300 rounded-lg shadow-md">
